  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: '0px 0.64px 2.16px -0.25px rgba(255, 255, 255, 0.01), 0px 1.93px 6.57px -0.5px rgba(255, 255, 255, 0.015), 0px 5.1px 17.36px -0.75px rgba(255, 255, 255, 0.02), 0px 8px 25px -1px rgba(255, 255, 255, 0.0075)',
        overflow: 'hidden',
        gap: '4px',
        position: 'relative',
        borderRadius: '8px',
